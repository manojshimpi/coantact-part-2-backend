...
const {userinfo, registerUser, registerNormalUser, loginUserNormal, updateUserProfile, updateUserNotificationSettings, updatePasswordNewPassword, googleLogin } = require("../controllers/authControllers");
